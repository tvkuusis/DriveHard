...
public class SaveLoadUtility : MonoBehaviour {
	...
	void Start () {
        ...
        saveGamePath = Application.dataPath + "/Saved Games";
    }
	...
	public void SaveGame(string saveGameName, List<Ghost> ghostList, List<float> checkpointList, List<Top10> top10Times) {
        ...
        newSaveGame.bestRun = new List<Ghost>(ghostList);
        newSaveGame.bestRunTimes = new List<float>(checkpointList);
        newSaveGame.top10 = new List<Top10>(top10Times);
	...
	public void LoadGame(string saveGameName) {
        ...
        lm.bestRun = new List<Ghost>(loadedGame.bestRun);
        if(loadedGame.bestRunTimes != null) {
            lm.bestRunTime = new List<float>(loadedGame.bestRunTimes);
        }
        if(loadedGame.top10 != null) {
            lm.leaderBoard = new List<Top10>(loadedGame.top10);
        }
